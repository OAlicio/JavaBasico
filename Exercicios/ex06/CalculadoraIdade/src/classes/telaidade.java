...
public class telaidade extends javax.swing.JFrame {
    ...
    public telaidade() {
        initComponents();
        Calendar anoat = Calendar.getInstance();
        int ant = anoat.get(Calendar.YEAR);
        lblANA.setText(Integer.toString(ant));
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("*Imagens Aqui*");

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel3.setText("Ano Atual");

        lblANA.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        lblANA.setText("0");
    ...
    private void btnCalcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcActionPerformed
        ...
        //int idade = ant - ano;
        int idade = (Integer.parseInt(lblANA.getText())) - ano;
